...
<header id="header" class="fixed-top d-flex align-items-center header-transparent">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <div class="logo me-auto">
            <h1><a href="index.html">FastBooking</a></h1>
                ...
                <div class="carousel-item active" style="background-image: url(assetss/img/slide/slide-1.jpg);">
                    <div class="carousel-container">
                        <div class="carousel-content">
                            <h2 class="animate__animated animate__fadeInDown"><span>Fast</span> Booking</h2>
    ...
    <section id="about" class="about">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 align-items-stretch video-box" style='background-image: url("/assetss/img/about.jpg");'>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active show" id="tab-1">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="/assetss/img/specials-1.jpg" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab-2">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="/assetss/img/specials-2.jpg" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab-3">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="/assetss/img/specials-3.jpg" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab-4">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="/assetss/img/specials-4.jpg" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab-5">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="/assetss/img/specials-5.jpg" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="row event-item">
                            <div class="col-lg-6">
                                <img src="/assetss/img/event-birthday.jpg" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="row event-item">
                            <div class="col-lg-6">
                                <img src="/assetss/img/event-private.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="col-lg-6 pt-4 pt-lg-0 content">
                    ...
                    <div class="swiper-slide">
                        <div class="row event-item">
                            <div class="col-lg-6">
                                <img src="/assetss/img/event-custom.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="col-lg-6 pt-4 pt-lg-0 content">
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="/assetss/img/gallery/gallery-1.jpg" class="gallery-lightbox">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="/assetss/img/gallery/gallery-2.jpg" class="gallery-lightbox">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="/assetss/img/gallery/gallery-3.jpg" class="gallery-lightbox">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="/assetss/img/gallery/gallery-4.jpg" class="gallery-lightbox">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="/assetss/img/gallery/gallery-5.jpg" class="gallery-lightbox">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="/assetss/img/gallery/gallery-6.jpg" class="gallery-lightbox">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="/assetss/img/gallery/gallery-7.jpg" class="gallery-lightbox">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="/assetss/img/gallery/gallery-8.jpg" class="gallery-lightbox">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="/assetss/img/chefs/chefs-1.jpg" class="img-fluid" alt=""></div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="/assetss/img/chefs/chefs-2.jpg" class="img-fluid" alt=""></div>
                        <div class="member-info">
                            <h4>Sarah Jhonson</h4>
                            <span>Patissier</span>
                            <div class="social">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="/assetss/img/chefs/chefs-3.jpg" class="img-fluid" alt=""></div>
                        <div class="member-info">
